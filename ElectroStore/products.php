        ...
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    ...
                    <p>We have the best cameras, watches and smartphones for you.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/note20.jpg" alt="note20">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/ip11pro.jpg" alt="ip11pro">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Iphone 11 max pro</h3>
                                    <p>Price: Rs. 120000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Sms20.webp" alt="Sms">
                            </a>
                            <center>
                                <div class="caption">
           ...
           <footer class="footer">
               ...
               <center>
                   ...
                   <p>This website is developed by Shatadru Sarkar</p>
               </center>
               </div>
           </footer>
        </div>
